      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-white shadow-lg rounded-lg">
        ...
        <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-6 rounded-lg shadow-md">
          ...
          <p className="text-lg text-white mb-4">
            ...
            They started with "Caribbean Student Association," which, let’s be honest, sounded about as exciting as a lecture on tax law. Trai couldn’t let his legacy be tied to something so... bland.
          </p>
          <p className="text-lg text-white mb-4">
          ...
          <p className="text-lg text-white">
            ...
            dance-offs to cultural deep dives, it’s no wonder people flock to it like it’s Carnival. Under the leadership of their nine-member dream team of e-board members, the club has become the ultimate hub 
